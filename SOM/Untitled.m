...
satdata.bstar = BStar;
load Epoch.mat
tsince = fix((Mjd_Epoch(2) - Mjd_Epoch(1))*1440); % amount of time in which you are going to propagate satellite's state vector forward (+) or backward (-) [minutes] 
%tsince = 917.463197037578;
[rteme, vteme] = sgp4(tsince, satdata)


rteme = rteme*1000;
plot3(rteme(1),rteme(2),rteme(3),'ob')
